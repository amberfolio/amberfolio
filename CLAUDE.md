...
**Status.** M0–M6 are done and `v0.8.0` is the current tag, an interim
one inside M7 (the GOG/Steam release boots, saves and reads its journal
as sold: #396–#398; every copy plays Tandy sound: #404, #407). The game boots, plays end to end, all six v1 enhancements work and toggle
