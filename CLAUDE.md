...
(onboarding and shells); its worklist is #265. Gamepad input and the CRT
look are **M8**, the first milestone past 1.0 (#372). Open issues are
the complete list of known gaps; docs describe what *is*, not what is
owed.
